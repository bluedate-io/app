...
import { AdminOptInReminderController } from "@/controllers/AdminOptInReminderController";
...
import { AdminOptInReminderRepository } from "@/repositories/AdminOptInReminderRepository";
...
import { AdminOptInReminderService } from "@/services/AdminOptInReminderService";
...
const adminOptInReminderRepository = new AdminOptInReminderRepository(db);
...
const adminOptInReminderService = new AdminOptInReminderService(
  adminOptInReminderRepository,
);
...
const adminOptInReminderController = new AdminOptInReminderController(
  adminOptInReminderService,
);
