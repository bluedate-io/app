// POST /api/admin/match/delete-card — JSON body { url } removes uploaded match-card image from storage
...
export async function POST(req: NextRequest) {
  try {
    ...
    return await container.adminMatchmakingController.deleteMatchCard(req, adminId);
  } catch (e) {
